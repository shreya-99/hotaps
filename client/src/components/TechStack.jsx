...
const CategoryPanel = ({ cat, showHeader }) => {
  ...
  return (
    <div
      ref={ref}
      className="reveal tech-stack__panel"
      style={{ '--cat-color': cat.color }}
    >
      {showHeader && (
        <div className="tech-stack__cat-header">
          <span className="tech-stack__cat-icon" aria-hidden="true">{cat.icon}</span>
      ...
      <div className="tech-stack__tools" role="list">
        {cat.tools.map((tool, i) => (
          ...
          >
            <span className="tech-stack__tool-icon" aria-hidden="true">{tool.icon}</span>
...
const TechStack = () => {
  ...
  const visibleCategories =
    activeId === 'all'
      ? techStack
      : techStack.filter((cat) => cat.id === activeId);
    ...
    <section className="section tech-stack" id="tech-stack" aria-labelledby="tech-stack-heading">
      ...
      <div className="container">
        ...
        <div className="tech-stack__tabs" role="tablist" aria-label="Technology categories">
          ...
          >
            <span className="tech-stack__tab-icon" aria-hidden="true">⬡</span>
            All
          </button>
          ...
          {techStack.map((cat) => (
            ...
            >
              <span className="tech-stack__tab-icon" aria-hidden="true">{cat.icon}</span>
              {cat.category}
            </button>
          ))}
        </div>
