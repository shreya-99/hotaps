    ...
    <section className="section why-us" id="why-us" aria-labelledby="why-us-heading">
      <div className="container">
        ...
        <div className="why-us__explorer">
          <div className="why-us__list" role="tablist" aria-label="Why choose us">
            {items.map((item, i) => (
              ...
              >
                ...
                <span className="why-us__list-icon" aria-hidden="true"><Icon name={item.icon} size={18} /></span>
          ...
          <div className="why-us__detail glass-card" key={activeIndex} role="tabpanel">
            ...
            <div className="why-us__detail-top">
              ...
              <div className="why-us__detail-icon" aria-hidden="true"><Icon name={active.icon} size={32} /></div>
            </div>
